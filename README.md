...
Algoritmo de propagação ao clicar em célula vazia tem falhas — células adjacentes nem sempre são reveladas corretamente
Tela de configuração tem 3 níveis (Principiante, Intermediário, Especialista) — apenas o Especialista está implementado, os outros alteram o número de bombas mas o grid não muda de tamanho

Contexto
Projeto marco no aprendizado — primeira tentativa de implementar lógica complexa de jogo sem referências disponíveis para RealBasic na época.
